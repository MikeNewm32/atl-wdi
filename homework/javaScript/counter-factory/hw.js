...
const Presenter = {
  insertCounterComponent: function(newCountId){
    ...
    newCounterComponent.innerHTML = `<h3>Count: <span>0</span></h3> <button class='increment'> +1 </button> <button class='delete'> Delete </button>`;    newCounterComponent.className += ' counter';
